...
noob - very weak and very stupid. If welcomed, becomes user.

user - standard guy without any special powers. If user is especially
good, he gets promoted to admin.

vandal - there are several types, but all of them are very evil
...
switch weapon between banhammer and bare hands (you wield no weapon by
default). Banhammer doubles changes that you get to your stats during
combat. ('w')
